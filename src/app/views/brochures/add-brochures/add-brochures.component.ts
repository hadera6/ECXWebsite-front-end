...
@Component({
  selector: 'app-add-brochures',
  templateUrl: './add-brochures.component.html',
  styleUrls: ['./add-brochures.component.scss']
})
export class AddBrochuresComponent implements OnInit {
  ...
  async submitForm () {
    ...
    this.response = await this.service.createBrochure(formData);
