...
@Component({
  selector: 'app-edit-brochures',
  templateUrl: './edit-brochures.component.html',
  styleUrls: ['./edit-brochures.component.scss']
})
export class EditBrochuresComponent implements OnInit {
  ...
  constructor(
    ...
    private service:BrochuresService,
  ...
  async ngOnInit() {
    ...
    this.getResponse = await this.service.getBrochure(this.id);
  ...
  async submitForm () {
    ...
    this.editResponse = await this.service.editBrochure(formData);
