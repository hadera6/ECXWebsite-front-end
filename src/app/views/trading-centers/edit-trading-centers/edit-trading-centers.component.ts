...
@Component({
  selector: 'app-edit-trading-centers',
  templateUrl: './edit-trading-centers.component.html',
  styleUrls: ['./edit-trading-centers.component.scss']
})
export class EditTradingCentersComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.getResponse = await this.service.getTradingCenter(this.id);
  ...
  async submitForm () {
    ...
    this.editResponse = await this.service.editTradingCenter(formData);
