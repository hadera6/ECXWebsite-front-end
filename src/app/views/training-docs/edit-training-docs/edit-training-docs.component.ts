...
@Component({
  selector: 'app-edit-training-docs',
  templateUrl: './edit-training-docs.component.html',
  styleUrls: ['./edit-training-docs.component.scss']
})
export class EditTrainingDocsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.getResponse = await this.service.getTrainingDoc(this.id);
  ...
  async submitForm () {
    ...
    this.editResponse = await this.service.editTrainingDoc(formData);
